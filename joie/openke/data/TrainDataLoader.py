...
class TrainDataLoader(object):
	...
	def __init__(self, in_path = "./", batch_size = None, nbatches = None,
				 threads = 8, sampling_mode = "normal", bern_flag = 0, filter_flag = 1, neg_ent = 1, neg_rel = 0):
	...
	def read(self):
		...
		print('TrainDataLoader read tripleTotal', self.tripleTotal)
		print('TrainDataLoader read batch_size', self.batch_size)
		print('TrainDataLoader read negative_ent', self.negative_ent)
		print('TrainDataLoader read negative_rel', self.negative_rel)
		print('TrainDataLoader read batch_seq_size', self.batch_seq_size)
